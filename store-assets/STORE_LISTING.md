...
你是否为了查一个单词，频繁在翻译软件和网页之间切换？
你是否担心写出的英语是"中式英语"，却没人纠正？
你是否背了单词如果不去用，几天就忘了？

「敲敲学英语」让英语学习融入你的每一次键盘敲击。不打断心流，在真实使用场景中自然习得。

✨ 核心亮点

【1. 零干扰即时翻译】
• 在任何输入框（邮件、Twitter、Notion...）输入中文。
• 轻按 Tab，地道英文即刻通过「虚影」浮现。
• 再按 Tab 确认，行云流水，快如闪电。

【2. AI 写作私教】
• 即使在大模型时代，细节依然决定成败。
• 我们内置了 DeepSeek / Google / GLM 多种顶尖 AI 模型。
• 它可以指出你的语法错误，教你更地道的 Native 表达，而不仅仅是简单的翻译。

【3. 看得见的进步 (New!)】
• 独家「学习洞察」面板：可视化你的学习轨迹。
• 自动记录生词，基于艾宾浩斯曲线智能安排复习。
• 看着词汇量曲线每天上涨，学习成了一场有反馈的游戏。

🛡️ 隐私与安全
• 本地优先 (Local-First) 架构：你的学习数据只存储在本地，不上传服务器。
• 权限最小化：我们只在您主动触发时工作。

� 适合谁？
• 需要频繁撰写英文邮件的职场人
• 正在备考雅思/托福，需要纠正中式英语的学生
• 每一个希望在潜移默化中提升英语的终身学习者

立即添加到 Chrome，开启你的无痛英语提升之旅！🌱
```
...
## 关键词 (Keywords)
English learning, AI writing, translation, vocabulary builder, grammar check, typing practice, DeepSeek
